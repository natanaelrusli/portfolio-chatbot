...
export default function Home() {
  ...
  return (
    <div className="flex h-dvh flex-col bg-white dark:bg-zinc-900">
      ...
      <div
        ref={scrollRef}
        className="flex-1 overflow-y-auto scroll-smooth bg-zinc-50 px-3 py-4 dark:bg-zinc-900 sm:px-4 sm:py-6 md:px-6"
      >
        <div className="mx-auto flex max-w-2xl flex-col gap-3 sm:gap-4">
          {!hasMessages && (
            <div className="flex flex-col items-center justify-center gap-6 px-2 py-12 sm:gap-8 sm:py-20">
              <motion.div
              ...
              >
                <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-violet-100 ring-1 ring-violet-200 dark:bg-violet-500/15 dark:ring-violet-500/25">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-linear-to-br from-violet-500 to-indigo-600 text-lg font-bold text-white">
                    AI
                  </div>
                </div>
                ...
                <p className="max-w-sm text-xs text-zinc-500 dark:text-zinc-400 sm:text-sm">
                  I can answer your questions about my experience, skills,
                  projects, and more. Try one of the suggestions below.
                </p>
              </motion.div>
              <SuggestedQuestions
